...
export const editableRootStyle = {
  ...
  '--slot4-page-text': '#151a27',
  '--slot4-panel-bg': '#f2f3f5',
  '--slot4-surface-bg': '#ffffff',
  '--slot4-muted-text': '#656c79',
  '--slot4-soft-muted-text': '#999999',
  '--slot4-accent': '#f15a2b',
  '--slot4-accent-fill': '#f15a2b',
  '--slot4-accent-soft': '#fff0e8',
  '--slot4-on-accent': '#ffffff',
  '--slot4-dark-bg': '#151a27',
  ...
  '--editable-border': '#e4e2de',
  '--editable-nav-bg': '#ffffff',
  '--editable-nav-text': '#1a1a1a',
  '--editable-nav-active': '#f15a2b',
  '--editable-nav-active-text': '#ffffff',
  '--editable-cta-bg': '#f15a2b',
  '--editable-cta-text': '#ffffff',
  '--editable-search-bg': '#ffffff',
  '--editable-footer-bg': '#151a27',
