export const siteIdentity = {
  code: process.env.NEXT_PUBLIC_SITE_CODE || 'hoorness',
  name: process.env.NEXT_PUBLIC_SITE_NAME || 'Hoorness',
  ...
  domain: process.env.NEXT_PUBLIC_SITE_DOMAIN || 'hoorness.com',
  url: process.env.NEXT_PUBLIC_SITE_URL || 'https://hoorness.com',
